...
<template>
  <button
    class="inline-flex items-center font-medium rounded-md text-xs px-2 py-1 gap-1"
    :class="{
      'bg-neutral-50 text-neutral-700': enabled,
      'bg-neutral-700 text-neutral-50': !enabled,
    }"
    @click="
      () => {
        enabled = !enabled;
